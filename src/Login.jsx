    ...
    <div className="flex h-screen w-screen bg-gray-100">
      ...
      <div className="flex w-full h-full bg-white shadow-lg rounded-2xl">
        ...
        <div className="w-full lg:w-1/2 h-full flex flex-col justify-center items-start px-8 sm:px-24">
          ...
          <h2 className="text-4xl font-bold text-gray-900 text-center w-full">WELCOME BACK</h2>
          ...
          <form onSubmit={handleLogin} className="w-full space-y-4">
            ...
            <div className="flex justify-between items-center text-sm text-gray-600 w-full">
              ...
              <Link to="/forget" className="text-red-500 cursor-pointer hover:underline">
                Forgot password?
              </Link>
            </div>
          ...
          <p className="mt-4 text-gray-600 text-center">
            ...
            <Link to="/signup" className="text-red-500 hover:underline font-semibold ml-1">
              Sign up for free!
            </Link>
          </p>

          {/* Company Branding - "MacroMeter" */}
          <p className="mt-8 text-gray-400 text-center w-full text-sm">
            © 2025 MacroMeter. All rights reserved.
          </p>
        </div>

        {/* Right Section - White Background & Centered Image */}
