...
import foodImage from "./assets/newPasswordFood.jpg"
        ...
        <div className="flex h-screen w-screen bg-gray-100">
            <div className="flex w-full h-full bg-white shadow-lg rounded-2xl">
                ...
                <div className="w-full lg:w-1/2 h-full flex flex-col justify-center items-start px-8 sm:px-24">
                    ...
                    <h2 className="text-4xl font-bold text-gray-900 text-center w-full">Set New Password</h2>
                    <p className="text-gray-500 mb-6 text-center w-full">Enter your new password below.</p>

                    {message && <p className="text-green-500 text-sm mb-2">{message}</p>}

                    <form onSubmit={handleSetPassword} className="w-full space-y-4">
                        <div>
                            <label className="text-gray-700 font-medium block">New Password</label>
                        ...
                        <div>
                            <label className="text-gray-700 font-medium block">Confirm New Password</label>
                            <div className="relative mt-1">
                                <FaLock className="absolute left-3 top-1/2 transform -translate-y-1/2 text-gray-400"/>
                                <input
                                    type="password"
